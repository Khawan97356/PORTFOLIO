    ...
    <section className="text-white mt-20 relative overflow-hidden" id="about">
      <div className="max-w-7xl mx-auto px-4 md:grid md:grid-cols-2 gap-12 items-center py-16 xl:px-16 relative z-10">
        ...
        <div data-aos="fade-right">
          <h2 className="text-4xl md:text-5xl font-extrabold text-white mb-6">More <span className="text-primary">About</span> Me</h2>

          <p className="text-gray-400 text-base lg:text-lg mb-10 leading-relaxed">Lorem ipsum dolor sit amet consectetur adipisicing elit. Voluptatibus incidunt odit inventore ipsum magnam.
            <br /><br />Veniam inventore ut iure quidem aliquam, voluptates error rem tempore quod. Quo reiciendis fugit modi itaque!</p>
        ...
        <div className="mt-16 md:mt-0 flex justify-center lg:justify-end relative" data-aos="fade-left">
          <div className="relative w-72 h-72 md:w-80 md:h-80">
            ...
            <div className="relative w-full h-full rounded-full overflow-hidden bg-[#111a3e] border border-[#1f1641]">
              <img src={about} alt="About me illustration" className="w-full h-full object-cover transition-transform duration-500 hover:scale-110" />
            </div>
          </div>
        </div>
